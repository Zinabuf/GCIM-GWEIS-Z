...
#---- Read data ----#
gcim_adj  <- fread("trait1_out_b_gcim_gweis-z.txt")
gcim_raw  <- fread("trait1_out_b_gcim_gweis.txt")
gweis_adj <- fread("trait1_out_b_gweis-z.txt")
gweis_raw <- fread("trait1_out_b_gweis.txt")
