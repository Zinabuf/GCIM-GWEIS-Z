...
_Detailed instructions for downloading and preparing `w_hm3.snplist` and `eur_w_ld_chr/` reference files are available from the [LDSC Wiki](https://github.com/bulik/ldsc/wiki/Heritability-and-Genetic-Correlation) tutorials Page._
