...
_Detailed instructions for downloading and preparing `w_hm3.snplist` and `eur_w_ld_chr/` reference files are available from the official [LDSC](https://github.com/bulik/LDSC) GitHub repository and associated [LDSC Wiki](https://github.com/bulik/ldsc/wiki/Heritability-and-Genetic-Correlation) tutorials._
